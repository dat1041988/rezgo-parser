<?php
	...
	*/
	...
	// Your company ID and your API KEY for Rezgo API access
	// They can both be found on the API Access settings page here ... https://supplier.rezgo.com/settings/api/
	// Learn how to create API keys here ... https://www.rezgo.com/support-article/create-api-keys
	define(	"REZGO_CID", "");
	...
	*/
	...
	// The source of this API request, can take WL (white label), WP (wordpress), RP (rezgo-parser), API or a custom string
	...
	*/
	...
	// Send the API requests to Firebug, to avoid disrupting the page design
