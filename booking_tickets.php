...
<html lang="en">
	<head>
		...
		<!--[if IE 7]><link href="<?=$site->path?>/css/font-awesome-ie7.css" rel="stylesheet"><![endif]-->
		<link href="<?=$site->path?>/css/rezgo.css" rel="stylesheet">
		<? if($site->exists($site->getStyles())) { echo '<style>'.$site->getStyles().'</style>'; } ?>
	</head>
    ...
    <? } ?>
		<?=$site->getTemplate('booking_tickets')?>
	</body>
</html>